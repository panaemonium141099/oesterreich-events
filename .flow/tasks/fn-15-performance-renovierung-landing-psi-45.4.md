...
- `src/app/layout.tsx` — GA4-Script auf `next/script strategy="afterInteractive"`
...
- [ ] GA4-Script lädt via `next/script strategy="afterInteractive"` (verifiziert
      via DevTools: gtag.js wird nach DOM-ready geladen, nicht blocking)
...
- [ ] **Landing-Smoke-Tests unter neuen Headers (`/` mit COOP/COEP):**
  ...
  - GA4 `gtag.js` lädt und sendet Beacon (verifiziert: DevTools-Network zeigt
    Request zu `google-analytics.com/g/collect`)
