          ...
          {stays.map((stay) => {
            ...
            return (
              <a
                ...
                className="press-haptic flex flex-col gap-1.5 rounded-2xl border border-[var(--v4-hairline-2)] bg-[var(--v4-surface-elevated)] hover:border-[var(--v4-hairline-3)] transition-colors p-4"
              >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mt-5">
          {city && (
            <a
              ...
              data-track-provider="booking"
              className="press-haptic inline-flex items-center gap-1.5 rounded-xl bg-[var(--v4-ink)] text-[var(--v4-bg)] text-[12.5px] font-semibold px-4 py-2 w-fit"
            >
