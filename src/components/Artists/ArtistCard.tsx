...
export function ArtistCard({
  ...
  return (
    <div className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03] border border-white/[0.06] hover:border-white/[0.12] transition-colors">
      {/* Artist image */}
      <div className="w-12 h-12 rounded-full bg-white/[0.08] flex-shrink-0 overflow-hidden">
        {imageUrl ? (
          <img
            src={imageUrl}
            alt={name}
