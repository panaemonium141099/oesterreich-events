      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-50 bg-[#1a1a1c] border-t border-white/[0.08] rounded-t-2xl px-4 pb-8 pt-4"
          >
            {/* Drag handle */}
            ...
            {/* Title */}
            <h3 className="text-white/80 font-medium text-base mb-5">
            ...
            {!showFriendPicker ? (
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-2 p-4 rounded-xl hover:bg-white/[0.06] transition-colors min-w-[80px]"
                >
                  <div className="w-12 h-12 rounded-full flex items-center justify-center bg-white/[0.1]">
                    {copied ? (
                ...
                >
                  ...
                  <span className="text-[11px] text-white/50">WhatsApp</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[11px] text-white/50">Facebook</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[11px] text-white/50">Email</span>
                </button>
                ...
                {user && (
                  ...
                  >
                    ...
                    <span className="text-[11px] text-white/50">An Freund</span>
                  </button>
                )}
              </div>
            ) : (
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="flex-1 bg-white/[0.06] border border-white/[0.08] rounded-lg px-3 py-2 text-sm text-white/80 placeholder-white/30 outline-none focus:border-white/20 transition-colors"
                    autoFocus
                  />
                </div>
                ...
                <div className="max-h-60 overflow-y-auto space-y-1">
                  {loadingFriends ? (
                    <div className="text-center py-6 text-white/30 text-sm">Laden...</div>
                    ...
                    filteredFriends.map((friend) => (
                      <button
                        ...
                        className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-white/[0.06] transition-colors disabled:opacity-50"
                      >
                        {friend.avatar_url ? (
                          <img
                          ...
                          <div className="w-9 h-9 rounded-full bg-white/[0.08] ring-1 ring-white/10 flex items-center justify-center text-xs font-semibold text-white/50">
