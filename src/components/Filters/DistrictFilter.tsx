...
export function DistrictFilter({ value, onChange, bundeslandId, eveningMode }: DistrictFilterProps) {
  const districts = bundeslandId ? getDistrictsByBundesland(bundeslandId) : [];
