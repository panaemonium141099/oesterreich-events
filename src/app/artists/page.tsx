      ...
      <main className="max-w-2xl mx-auto px-4 pt-6 space-y-8">
        ...
        <section>
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-white/30 focus:outline-none focus:border-white/30 transition-colors text-sm"
            />
            <button
              onClick={handleManualAdd}
              disabled={!manualInput.trim() || manualAdding}
              className="px-4 py-3 rounded-xl bg-white/10 text-white/80 hover:bg-white/15 font-medium text-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed shrink-0"
            >
              {manualAdding ? (
        ...
        <section>
          <h2 className="text-sm uppercase tracking-[0.15em] text-white/40 font-medium mb-3">
            ...
            {followedArtists.length > 0 && (
              <span className="ml-2 text-white/20">({followedArtists.length})</span>
            )}
          </h2>
        ...
        <section className="pb-4">
          <Link
            ...
            className="flex items-center justify-between w-full px-4 py-3 rounded-xl bg-white/5 border border-white/[0.06] hover:border-white/[0.12] transition-colors"
          >
            <div className="flex items-center gap-3">
