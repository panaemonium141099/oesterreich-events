...
export const metadata: Metadata = {
  ...
  description:
    'Alles über die großen Festivals und Veranstaltungen in Österreich 2026. Termine, Lineups, Tickets, Anreise und Insidertipps.',
  openGraph: {
    title: 'Festival-Blog 2026 — LassTreffen.at',
    description: 'Österreichs große Festivals 2026 — Nova Rock, Donauinselfest, Frequency und mehr.',
    images: [{ url: FESTIVAL_POSTS[0].heroImage }],
  },
};
...
export default function BlogPage() {
  const [hero, ...rest] = FESTIVAL_POSTS;
      ...
      <div className="max-w-5xl mx-auto px-6 py-14">
        ...
        <header className="mb-14">
          ...
          <p className="text-gray-500 text-xl font-light max-w-lg leading-relaxed">
            Die größten Musikereignisse Österreichs — alles was du wissen musst.
          </p>
        </header>
