/**
 * GET /api/newsletter/unsubscribe?email=…&token=… — Ein-Klick-Abmeldung
 * (Link steht in jeder Digest-Mail, DSGVO-Pflicht).
 */
...
export async function GET(req: NextRequest) {
  ...
  if (!email || !(await verifyNewsletterToken('unsub', email, token))) {
  ...
  return page('Abgemeldet', 'Du bekommst keine weiteren Newsletter von uns. Danke, dass du dabei warst — du bist jederzeit wieder willkommen.');
}
