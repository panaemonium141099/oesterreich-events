      ...
      <div className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="space-y-8 text-white/70 leading-relaxed">
          ...
          <section>
            ...
            <h3 className="text-base font-medium text-white/90 mt-4 mb-2">AWIN / Affiliate-Tracking</h3>
            <p>
              Bei Ticketkäufen über externe Anbieter (z.B. oeticket, Eventim) können Affiliate-Tracking-Cookies
              von AWIN gesetzt werden, um die Vermittlung nachzuvollziehen.
              Anbieter: AWIN AG, Berlin, Deutschland.
            </p>
          </section>
