 ...
 * Server-rendered with JSON-LD structured data. ~60+ events per month. Very rich source.
 */
export class AAUScraper extends UniBaseScraper {
  readonly name = 'aau-klagenfurt';
  protected readonly shortName = 'AAU';
  protected readonly baseUrl = 'https://www.aau.at';
  protected readonly eventListUrl = 'https://www.aau.at/veranstaltungen/';
