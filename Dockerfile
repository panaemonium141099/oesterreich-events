...
ARG NEXT_PUBLIC_ADSENSE_SLOT_EVENT
ARG NEXT_PUBLIC_ADSENSE_SLOT_BLOG
ARG NEXT_PUBLIC_ADSENSE_SLOT_ACTIVITY
ARG NEXT_PUBLIC_SITE_URL
ARG NEXT_PUBLIC_VAPID_PUBLIC_KEY
ARG NEXT_PUBLIC_SPOTIFY_CLIENT_ID
ARG NEXT_PUBLIC_ADSENSE_CLIENT_ID
...
ENV NEXT_PUBLIC_ADSENSE_SLOT_EVENT=$NEXT_PUBLIC_ADSENSE_SLOT_EVENT
ENV NEXT_PUBLIC_ADSENSE_SLOT_BLOG=$NEXT_PUBLIC_ADSENSE_SLOT_BLOG
ENV NEXT_PUBLIC_ADSENSE_SLOT_ACTIVITY=$NEXT_PUBLIC_ADSENSE_SLOT_ACTIVITY
ENV NEXT_PUBLIC_SITE_URL=$NEXT_PUBLIC_SITE_URL
ENV NEXT_PUBLIC_VAPID_PUBLIC_KEY=$NEXT_PUBLIC_VAPID_PUBLIC_KEY
ENV NEXT_PUBLIC_SPOTIFY_CLIENT_ID=$NEXT_PUBLIC_SPOTIFY_CLIENT_ID
ENV NEXT_PUBLIC_ADSENSE_CLIENT_ID=$NEXT_PUBLIC_ADSENSE_CLIENT_ID
