...
// Interner Next-Pfad. Bewusst hart importiert statt weich abgesichert: wenn
// ein Next-Upgrade ihn verschiebt, soll der Build laut scheitern statt still
// ohne Cache weiterzulaufen. Ein stiller Cache-Ausfall wäre der schlechtere
// Zustand — die Seite bliebe zwar oben, würde aber jede Anfrage gegen die
// Supabase-Micro-Instanz rendern.
const fileSystemCacheModule = require('next/dist/server/lib/incremental-cache/file-system-cache');
const FileSystemCache = fileSystemCacheModule.default || fileSystemCacheModule;
